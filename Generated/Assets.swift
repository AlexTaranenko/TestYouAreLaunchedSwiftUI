...
internal enum Asset {
  ...
  internal enum Images {
    internal static let iconFavoriteNormal = ImageAsset(name: "icon_favorite_normal")
    internal static let iconFavoriteSelected = ImageAsset(name: "icon_favorite_selected")
